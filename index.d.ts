// Type definitions for hq-gifencoder 0.1
// Project: https://gitlab.com/Miscoriadev/hq-gifencoder
// Definitions by: MuratColyaran <https://github.com/Muratcol>
...
declare class GIFEncoder extends Readable {
    ...
    /**
     * Write out a new high quality frame to the GIF.
     */
    addHQFrame(
        /**
         * ArrayLike of pixels (0x00 - 0xFF) for the new frame.
     ...
     * Start process
     */
    createReadStream(): iCreateReadStream;
